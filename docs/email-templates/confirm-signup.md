...
Copy the HTML below into Supabase Dashboard > Authentication > Email Templates > Confirm signup

## Subject Line

```
Confirm your Project Atlas account
```
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <p class="text-muted" style="margin: 0 0 32px 0; font-size: 16px; line-height: 24px; color: #71717a; text-align: center;">
                      Thanks for signing up for Project Atlas! Click the button below to verify your email address and activate your account.
                    </p>
                    <!-- Button -->
                    ...
                    <p class="text-muted" style="margin: 24px 0 0 0; font-size: 14px; line-height: 20px; color: #71717a;">
                      If you didn't create an account with Project Atlas, you can safely ignore this email.
                    </p>
