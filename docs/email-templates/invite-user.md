...
Copy the HTML below into Supabase Dashboard > Authentication > Email Templates > Invite user

## Subject Line

```
You've been invited to Project Atlas
```
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <p class="text-muted" style="margin: 0 0 32px 0; font-size: 16px; line-height: 24px; color: #71717a; text-align: center;">
                      You've been invited to join Project Atlas, a WotLK 3.3.5a Classic+ private server. Click the button below to accept your invitation and set up your account.
                    </p>
                    <!-- Button -->
