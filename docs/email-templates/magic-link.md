...
Copy the HTML below into Supabase Dashboard > Authentication > Email Templates > Magic link

## Subject Line

```
Your Project Atlas login link
```
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <p class="text-muted" style="margin: 0 0 32px 0; font-size: 16px; line-height: 24px; color: #71717a; text-align: center;">
                      Click the button below to securely sign in to your account. This magic link will log you in without needing a password.
                    </p>
                    <!-- Button -->
