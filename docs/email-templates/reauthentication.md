...
Copy the HTML below into Supabase Dashboard > Authentication > Email Templates > Reauthentication

This template is used when a user needs to verify their identity for sensitive account actions.

## Subject Line

```
Verify your identity - Project Atlas
```
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <p class="text-muted" style="margin: 0 0 24px 0; font-size: 16px; line-height: 24px; color: #71717a; text-align: center;">
                      To complete a sensitive action on your Project Atlas account, we need to verify your identity. Click the button below to confirm it's you.
                    </p>
                    <!-- Alert Box -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td class="alert-bg" style="padding: 16px; background-color: #fef3c7; border-radius: 8px; margin-bottom: 24px;">
                          <p style="margin: 0; font-size: 14px; line-height: 20px; color: #92400e;">
                            <strong>Security notice:</strong> We sent this verification because you (or someone) attempted to perform a sensitive action on your account.
                          </p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <p class="text-muted" style="margin: 24px 0 0 0; font-size: 14px; line-height: 20px; color: #71717a;">
                      If you didn't initiate this request, your account may be at risk. We recommend changing your password immediately and enabling two-factor authentication.
                    </p>
