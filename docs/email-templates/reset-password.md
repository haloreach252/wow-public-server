...
Copy the HTML below into Supabase Dashboard > Authentication > Email Templates > Reset password
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="content-bg" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                <tr>
                  <td style="padding: 40px 32px;">
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" style="padding-bottom: 24px;">
                          <div style="width: 64px; height: 64px; background-color: #fef3c7; border-radius: 50%; display: inline-block; line-height: 64px; text-align: center;">
                    ...
                    <!-- Subtext -->
                    <p class="text-muted" style="margin: 0 0 32px 0; font-size: 16px; line-height: 24px; color: #71717a; text-align: center;">
                      We received a request to reset the password for your Project Atlas account. Click the button below to create a new password.
                    </p>
                    <!-- Button -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 24px;">
                      <tr>
                        <td style="padding: 16px; background-color: #f4f4f5; border-radius: 8px;">
                          <p class="text-muted" style="margin: 0 0 8px 0; font-size: 13px; font-weight: 600; color: #52525b;">
                            Password tips:
                          </p>
                          <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #71717a; line-height: 20px;">
